...
const LeftBar = ({ setData1, setLength, setLD, setIsFilter }) => {
  ...
  const handleCondition = async () => {
    ...
    const response = await axios.get(
      `http://3.38.112.152:4000/conditions/${info.roadNo.selected}/${info.laneOps.checkboxes}/${info.facilOps.checkboxes}/${info.speedOps.checkboxes}/${info.barrierOps.checkboxes}/${info.lightOps.checkboxes}/${info.caronlyOps.checkboxes}/${info.onewayOps.checkboxes}`
    );
